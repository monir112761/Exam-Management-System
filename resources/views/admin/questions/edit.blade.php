...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        <h3 class="fw-bold mb-0">Edit Question</h3>
        <small class="text-muted">Dashboard / Questions / Edit</small>
    </div>
        ...
        <form action="{{ route('admin.questions.update',$question->id) }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text"
                           name="subject_name"
                           value="{{ old('subject_name', $question->subject_name) }}"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="question_type" class="form-select @error('question_type') is-invalid @enderror">
                        <option value="mcq" {{ old('question_type', $question->question_type ?? 'mcq') == 'mcq' ? 'selected' : '' }}>MCQ</option>
                        ...
                        <option value="descriptive" {{ old('question_type', $question->question_type) == 'descriptive' ? 'selected' : '' }}>Descriptive</option>
                    </select>
                    @error('question_type')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
            ...
            <div class="mb-3">
                ...
                <select name="correct_answer" class="form-select">
                    ...
                    <option value="A" {{ old('correct_answer',$question->correct_answer)=='A'?'selected':'' }}>Option A / True</option>

                    <option value="B" {{ old('correct_answer',$question->correct_answer)=='B'?'selected':'' }}>Option B / False</option>
